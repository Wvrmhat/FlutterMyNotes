      ...
      listener: (context, state) async {
       if (state is AuthStateRegistering)
       {
        if (state.exception is WeakPasswordAuthException)
        {
          ...
          await showErrorDialog(context, 'Failted to register');
                ...
                child: Column(
                  children: [
                    TextButton(
                      ...
                      //   try {
                      //     // uses authervice and handles auth related exceptions
                      //     AuthService.firebase().createUser(
                      //       email: email,
                      //       password: password,
                      //     );
                      //     AuthService.firebase()
                      //         .sendEmailVerification(); // verifies email from authservice
